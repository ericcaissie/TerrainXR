...
//using com.interiorlighting.controls;
        ...
        namespace interactor
        {
            public class SceneInteractor : MonoBehaviour
            {
                ...
                void SetDoorOpen(GameObject door)
                {
                    ...
                    **/
                    com.interiorlighting.controls.KeyboardHandler kh = GetComponent<com.interiorlighting.controls.KeyboardHandler>();
                    com.interiorlighting.controls.MouseHandler mh = GetComponent<com.interiorlighting.controls.MouseHandler>();
